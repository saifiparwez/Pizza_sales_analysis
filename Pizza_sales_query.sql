...
FROM
  ...
  Q3:  -- identitfy the highest prices of the pizza.--
SELECT 
...
Q4:-- Identify the most common pizza size  orders
...
Q7: -- join the necessary tables to find the 
...
ORDER BY revenue DESC;
 ...
 Q12:-- Analyze the cumulative revenue generated overtime.
